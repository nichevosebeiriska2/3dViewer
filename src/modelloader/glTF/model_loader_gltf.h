#ifndef MODEL_LOADER_GLTF_H
#define MODEL_LOADER_GLTF_H
...
//{
//public:
//	static ObjectWrapperGLTF * load(const QString &filePath);
//
//private:
...
//
//	static void processNode(aiNode *node, const aiScene *scene, std::vector<Mesh2> &meshes);
//	static Mesh2 processMesh(aiMesh *aiMesh, const aiScene *scene);
